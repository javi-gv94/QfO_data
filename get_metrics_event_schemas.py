    ...
    for name in os.listdir(os.getcwd()):
        ...
        for i, tool in enumerate(data.iloc[:, index]):
            ...
            info = {
                ...
                "_id":"QfO:2015-01-01_" + challenge_id + "_metricsEvent_" + participant + "_recall",
            ...
            # print info
            filename = "MetricsEvent_" + challenge_id + "_" + participant + "_recall.json"
            # print filename
            ...
            info = {
                ...
                "_id": "QfO:2015-01-01_" + challenge_id + "_metricsEvent_" + participant + "_precision",
                "_schema": "https://www.elixir-europe.org/excelerate/WP2/json-schemas/0.4/TestAction",
                "action_type": "MetricsEvent",
                "tool_id": "QfO:" + participant,
            ...
            # print info
            filename = "MetricsEvent_" + challenge_id + "_" + participant + "_precision.json"
            # print filename
